...
int main() {
    ...
    if (outFileStream.is_open()) {
        ...
        for (std::vector<Address>::reverse_iterator addressEntryIterator = addressesFromFile.rbegin();
            addressEntryIterator != addressesFromFile.rend();
            ++addressEntryIterator) {
            outFileStream << addressEntryIterator->getFullAddress();
        }
        outFileStream.close();
    }
